...
import { Calendar, Package, Truck, ShoppingCart, Check, X } from "lucide-react"
...
export default function BonsCommandePage() {
  const [bonsCommande, setBonsCommande] = useState(mockBonsCommande)
              ...
              {filteredBons.map((bon) => (
                <TableRow key={bon.id}>
                  ...
                  <TableCell className="font-medium">
                    {bon.totalTTC.toLocaleString()} DT
                  </TableCell>
