...
export const metadata: Metadata = {
  title: "PNEU SHOP - Le spécialiste du pneu pas cher en Tunisie | Pneumatiques en ligne",
  description:
  ...
  twitter: {
    ...
    title: "PNEU SHOP - Le spécialiste du pneu pas cher en Tunisie",
    description: "Vos pneumatiques en un seul clic. Livraison gratuite 24h/72h à partir de 2 pneus.",
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description: "Leader en Tunisie de la vente en ligne de pneumatiques",
              address: {
                "@type": "PostalAddress",
              ...
              sameAs: ["https://www.facebook.com/pneushop.tn", "https://www.instagram.com/pneushop.tn"],
            }),
          }}
        />
