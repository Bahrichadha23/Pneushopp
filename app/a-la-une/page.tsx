...
export default function ALaUnePage() {
  const newsItems = [
    ...
    },
    {
      ...
      excerpt: "Profitez de -20% sur tous les pneus Pirelli jusqu'à la fin du mois. Offre valable sur toute la gamme.",
    },
    {
      id: 3,
    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600">Découvrez nos dernières actualités, événements et promotions</p>
        </div>
